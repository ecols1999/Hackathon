...
import 'package:pet_house/controllers/FBStorage.dart';
import 'package:image_picker/image_picker.dart';
import 'package:keyboard_actions/keyboard_actions.dart';
import 'package:pet_house/subViews/threadItem2.dart'; //this should fix the text initialization issue
...
class _EditPost extends State<EditPost> {
  ...
  TextEditingController writingTextController =
      TextEditingController(text: poemText);
  TextEditingController titleTextController =
      TextEditingController(text: titleMain);
  //TextEditingController typeTextController = TextEditingController(text: title);
  ...
  void _postToFB() async {
    ...
    print('lovin ${typeTextController}');

    FBCloudStore.postUpdate(postID, writingTextController.text,
        titleTextController.text, typeTextController);
